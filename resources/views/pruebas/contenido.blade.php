                    ...
                    <tbody>
                        ...
                        @foreach ($contenidos as $contenido)
                            ...
                            <tr>
                                ...
                                <td>{{ $contenido->url }}</td>
                                <td>{{ $nameData[$contenido->contenido] }}/{{ $parentNameData[$contenido->tipo_contenido] }}
                                </td>
                              ...
                              <img id="myImg{{$contenido->id}}" class="myImg w-25 h-25" src="{{Storage::disk('s3')->url($contenido->url)}}"
                               alt="imagen" style="height:100 px;max-width:300px" onclick="getImage({{$contenido->id}})">
                                ...
                                <td>
                                    <a href="{{ Storage::disk('s3')->url($contenido->url) }}" data-lightbox="imagen"
                                        data-title="{{ $contenido->tipo_contenido }}">
                                        <img src="{{ Storage::disk('s3')->url($contenido->url) }}" alt=""
                                            width="60" height="70">
                                    </a>
